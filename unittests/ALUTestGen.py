...
# Description: 
#   Test generator for the ALU module for the RISC-V Processor
#
# Output:
#   Testvectors in binary format found in ./alutestvectors.input
#
# Authors:
...
loops = 1000 # If you want to run through the tests again, change this number, but also loops in ALUTestVectorTestbench.v
